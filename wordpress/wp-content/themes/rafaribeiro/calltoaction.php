<?php /* Template Name: Call-to-action Page */ ?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/calltoaction.css" type="text/css" />
        ...
        <div class="container">
            ...
            <div class="calltoaction__callout row">
                <div class="col-12">
                    ...
                    <br>
                    <div>
                        <span class="calltoaction__headline">08/01/2018 às 20:00h</span>
                    </div>
                </div>
            </div>
