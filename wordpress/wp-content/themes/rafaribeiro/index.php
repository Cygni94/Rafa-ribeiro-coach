        ...
        <div class="row">
            <div class="papo__callout col-md-6 col-12">
                ...
                <div class="papo__callout-img-sm col-10">
                    <img class="img-fluid" src="<?php bloginfo('template_directory'); ?>/img/rafa_ribeiro_logo_papo_momento_da_virada.png" alt="Papo Momento da Virada">
                </div>
                <span class="papo__callout-description">uma série de entrevistas com
                    <br>empreendedores super inspiradores</span>
                <br>
                <a href="index.php/callout/">
                    <button class="papo__callout-button">
